...
class WorkshopDetailCardSup extends StatefulWidget {
  Workshop workshop ;
  WorkshopDetailCardSup({@required this.workshop}) ;
  
  @override
  _WorkshopDetailCardSupState createState() => _WorkshopDetailCardSupState();
}

class _WorkshopDetailCardSupState extends State<WorkshopDetailCardSup> {
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {

        Navigator.pushNamed(context, '/sup', arguments: widget.workshop);
      },
      child: Container(
        // color: Colors.purple,
        // width: 100,
